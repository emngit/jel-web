      ...
      >
        ...
        <motion.div className="rp-hero-identity" variants={fadeUp}>
          ...
          <p className="rp-title-line">
            QA Analyst&nbsp;&nbsp;·&nbsp;&nbsp;Salesforce Analyst&nbsp;&nbsp;·&nbsp;&nbsp;Process Delivery Specialist – Order-To-Cash&nbsp;&nbsp;·&nbsp;&nbsp;Automation
          </p>
          ...
          <div className="rp-contact-row">
            ...
            <span className="rp-contact-item">
              ...
              <a href="https://github.com/jelanusga" target="_blank" rel="noopener noreferrer">GitHub</a>
            </span>
          </div>
